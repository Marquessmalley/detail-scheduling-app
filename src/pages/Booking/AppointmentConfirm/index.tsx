...
const AppointmentConfirm = () => {
  ...
  return (
    <div className="m-8">
      {location.state !== null ? (
        <div className="mx-auto grid h-fit max-w-lg grid-cols-1 gap-y-10 rounded-2xl border border-slate-300 p-12 dark:border-slate-700 dark:bg-slate-900/80 lg:max-w-6xl lg:grid-cols-12">
